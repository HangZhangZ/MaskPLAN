...
import numpy as np
import warnings
from MaskPLAN_BaseModel_vec import *
...
def main(args):
    ...
    LR_SCHEDULE = [(0, 1e-5),(50, 5e-6),(100, 2e-6),(150, 1e-6)]
    ...
    checkpoint = tf.keras.callbacks.ModelCheckpoint('MaskPLAN_Trained/%s_%s_vec/Model' % (args.part,args.model),"loss",0,True,True,"min","epoch",options=None,initial_value_threshold=None,)
    ...
    if args.part == 'Type':
        ...
        MaskPLAN_S.fit([Mask_T,Mask_L,Mask_A,Mask_S,Mask_R,bound,frontD,S_in,T_out,L_out,A_out],S_out,epochs=EPOCHS,batch_size=BATCH_SIZE,validation_split=args.val,shuffle=True,callbacks=callback)
