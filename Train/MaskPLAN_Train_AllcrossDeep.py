...
def main(args):
    ...
    checkpoint = tf.keras.callbacks.ModelCheckpoint('MaskPLAN_Trained/All_%s_Deep_cross/All' % (args.model),"val_loss",0,True,True,"min","epoch",options=None,initial_value_threshold=None,)
