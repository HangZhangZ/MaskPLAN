...
def main(args):
    ...
    os.makedirs('Inference/%s_Deep_vec/iteration/raw' % (args.model),exist_ok=True)
    os.makedirs('Inference/%s_Deep_vec/iteration/post' % (args.model),exist_ok=True)
    os.makedirs('Inference/%s_Deep_vec/iteration/partial_input' % (args.model),exist_ok=True)
    ...
    MaskPLAN.load_weights('MaskPLAN_Trained/All_%s_Deep_vec/All' % (args.model))
    ...
    class MaskPLAN_Inference():
        ...
        def partial_input(self,site_id):
            ...
            path = 'Inference/%s_Deep_vec/iteration/partial_input/%d.jpg' % (args.model,site_id)
        ...
        def inference_interation(self,site_id):
                            ...
                            if pts[n].ndim>1 and pts[n].shape[0]>2:
                                ...
                                if unioned_rooms:
                                    ...
                                    for t in range(4):
                                        ...
                                        pt1,pt2 = align_target(pt1,pt2,boundary_line,12)
            ...
            cv2.imwrite('Inference/%s_Deep_vec/iteration/raw/%d.png' % (args.model,site_id),reconstructed)
            cv2.imwrite('Inference/%s_Deep_vec/iteration/post/%d.png' % (args.model,site_id),reconst_post)
