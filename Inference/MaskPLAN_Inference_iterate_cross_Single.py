...
from MaskPLAN.MaskPLAN_BaseAll_cross import *
...
def main(args):
    ...
    output_root = REPO_ROOT / 'Inference' / ('%s_Single_cross' % args.model) / 'iteration'
    ...
    MaskPLAN.load_weights(str(REPO_ROOT / ('MaskPLAN_Trained/All_%s_Single_cross/All' % args.model)))
    ...
    class MaskPLAN_Inference():
        ...
        def __init__(self):
            ...
            self.partial_input_visual = np.zeros((130,80))*255 # 13 = 8 + 1 + 4
