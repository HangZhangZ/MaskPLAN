...
def main(args):
    ...
    class MaskPLAN_Inference():
        ...
        def inference_interation(self,site_id):
            ...
            cv2.imwrite('Inference/%s_Single_cross/iteration/raw/%d.png' % (args.model,site_id),reconstructed)
            cv2.imwrite('Inference/%s_Single_cross/iteration/post/%d.png' % (args.model,site_id),reconst_post)
